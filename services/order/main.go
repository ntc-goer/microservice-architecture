...
func main() {
	...
	if err := dp.ServiceDiscovery.RegisterService(instanceId, dp.Config.ServiceName, dp.Config.GRPCHost, dp.Config.GRPCPort, "http://host.docker.internal:8080/order/health"); err != nil {
